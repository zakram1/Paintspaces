  ...
  return (
    <Fragment>
        ...
        <div className='flex items-center justify-center'>
            <div className="flex flex-col items-center p-6 max-w-max bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mt-10">
                <h2 className="text-center mb-4 text-xl font-bold">Log In</h2>
                ...
                <form className="flex flex-col items-center justify-center gap-2 max-w-max" onSubmit={handleSubmit}>
                    ...
                    <button className="w-full p-2 text-white bg-blue-700 rounded-lg hover:bg-blue-800 mt-2">Log In</button>
                    <div className="w-100 text-center">
                        Dont have an account? <NavLink to="/signup" className={'text-blue-700 hover:underline'}>Sign Up</NavLink>
                    </div>
                    <div className="w-100 text-center">
